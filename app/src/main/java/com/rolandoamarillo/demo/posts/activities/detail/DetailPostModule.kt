...
class DetailPostModule {
    ...
    @ActivityScoped
    @Provides
    fun provideDetailPostPresenter(userRemoteDataSource: UserRemoteDataSource, postsLocalDataSource: PostsLocalDataSource): DetailPostContract.DetailPostPresenter {
        return DetailPostPresenter(userRemoteDataSource, postsLocalDataSource)
    }
